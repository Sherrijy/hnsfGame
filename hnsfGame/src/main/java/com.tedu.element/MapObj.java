...
//		先写一个假图片再说
		...
		case "GRASS": icon=new ImageIcon("images/wall/grass.png");break;
		case "BRICK": icon=new ImageIcon("images/wall/brick.png");break;
		case "RIVER": icon=new ImageIcon("images/wall/river.png");break;
		case "IRON": icon=new ImageIcon("images/wall/iron.png");
					this.hp=4;
					name="IRON";
					break;
		}
